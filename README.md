...
A Telegram bot for interactive server monitoring via [Beszel](https://github.com/henrygd/beszel) — a lightweight Docker monitoring platform. View cluster overview, system details, resource rankings, and alerts directly from Telegram.
